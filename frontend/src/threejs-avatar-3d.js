...
function updateWaveAnimation(delta) {
  ...
  // ============================================
  if (rLA) {
    rLA.rotation.x = baseRotations.rightLowerArm.x - raise * 0.4;  // Bend elbow up
    rLA.rotation.y = baseRotations.rightLowerArm.y + raise * 0.6;  // Forearm twist for natural pose
    rLA.rotation.z = 0;
  }
